...
$config['calendar_prefs']['template'] = <<<EOT
   ...
   {cal_cell_no_content}<span>{day}</span><br /><input style="width:70%;" type="text" name="y_{day}" value="" />{/cal_cell_no_content}
   {cal_cell_no_content_today}<span>{day}</span><br /><input style="width:70%;" type="text" name="y_{day}" value="" />{/cal_cell_no_content_today}
