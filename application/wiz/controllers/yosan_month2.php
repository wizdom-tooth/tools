...
//var_dump($yosan_week_infos);
        ...
        $addup_label = array();
        $keys = array_keys($addup_info[0]);
        foreach ($keys as $key)
        {
            $name = '';
            switch ($key)
            {
                case 'id':                 $name = '紹介ID';         break;
                case 'date':               $name = '紹介日';         break;
                case 'time_zone':          $name = '紹介時間帯';     break;
                case 'store_id':           $name = '店舗ID';         break;
                case 'store_name':         $name = '店舗名';         break;
                case 'channel':            $name = 'チャネル';       break;
                case 'area':               $name = 'エリア';         break;
                case 'pref':               $name = '都道府県';       break;
                case 'east_or_west':       $name = '東西';           break;
                case 'status':             $name = 'ステータス';     break;
                case 'contract_time_zone': $name = '契約時間帯';     break;
                case 'service':            $name = '契約回線';       break;
                case 'hikari':             $name = 'ひかり';         break;
                case 'isp':                $name = 'ISP';            break;
                case 'hikari_tel':         $name = 'ひかり電話';     break;
                case 'virus':              $name = 'ウィルスクリア'; break;
                case 'remote':             $name = 'リモート';       break;
                case 'router':             $name = 'ルータ';         break;
                case 'contract_date':      $name = '契約日';         break;
                case 'user_name':          $name = '契約担当者';     break;
                case 'hikari_tv':          $name = 'ひかりTV';       break;
                case 'benefit':            $name = '特典';           break;
                case 'complete_date':      $name = '完成日';         break;
                case 'wiz_month_id':       $name = 'ウィズ月';       break;
                case 'wiz_week_id':        $name = 'ウィズ週';       break;
