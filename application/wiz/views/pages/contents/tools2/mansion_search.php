...
switch ($jcn_yokohama_match[5])
{
    ...
    case 'デジタル未対応': $tv_bgcolor = '#DCDCDC'; break;
}
switch ($jcn_yokohama_match[6])
{
    case '対応可': $net_bgcolor = '#98FB98'; break;
    case '対応不可': $net_bgcolor = '#DCDCDC'; break;
}
switch ($jcn_yokohama_match[7])
{
    case '対応可': $tel_bgcolor = '#98FB98'; break;
    case '対応不可': $tel_bgcolor = '#DCDCDC'; break;
}
?>
<tr>
<td><?php echo $jcn_yokohama_match[1];?></td>
<td><?php echo $jcn_yokohama_match[2];?></td>
<td bgcolor="<?php echo $tv_bgcolor;?>"><?php echo $jcn_yokohama_match[5];?></td>
<td bgcolor="<?php echo $net_bgcolor;?>"><?php echo $jcn_yokohama_match[6];?></td>
<td bgcolor="<?php echo $tel_bgcolor;?>"><?php echo $jcn_yokohama_match[7];?></td>
<td><?php echo $jcn_yokohama_match[3];?></td>
<!--
